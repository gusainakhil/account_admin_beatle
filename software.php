    ...
    <div class="main-container">
        ...
        <div class="modal-content large-modal">
            <div class="modal-header">
                <h3><i class="fas fa-plus"></i> Add New Software</h3>
                ...
                <form id="addSoftwareForm">
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" id="softwareName" placeholder="e.g., RRMS, PA System" required>
                        </div>
                        <div class="form-group">
                            <label for="softwareShortName">Short Name</label>
                            <input type="text" id="softwareShortName" placeholder="e.g., RRMS" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                            <label for="softwareColor">Theme Color</label>
                            <input type="color" id="softwareColor" value="#1a73e8">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="softwareDescription" rows="3"
